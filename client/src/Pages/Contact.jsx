...
function Contact() {
  ...
  <div className="flex flex-col items-start space-y-4">
    <div className="flex items-center text-lg font-semibold sm:text-base">
      <a href="mailto:xw1se.so2@gmail.com" className="flex items-center ">
    ...
    <div className="flex items-center text-lg font-semibold sm:text-base">
      <a href="https://t.me/web3buffett" target="_blank" rel="noopener noreferrer" className="flex items-center ">
        <FaLinkedin className="mr-3 text-2xl" />
        <span className="ml-3 form-level text-blue-600 hover:underline">https://t.me/web3buffett</span>
      </a>
    </div>
    <div className="flex items-center text-lg font-semibold  sm:text-base">
      <a href="https://github.com/Rukandel" target="_blank" rel="noopener noreferrer" className="flex items-center ">
        <FaGithub className="mr-3 text-2xl" />
        <span className="ml-3 form-level text-blue-600 hover:underline">github.com/Rukandel...</span>
      </a>
    </div>
  </div>
</div>
