            ...
            <div className="container mx-auto flex flex-wrap justify-between max-w-[90%]">
                ...
                <div className="footer-section">
                    ...
                    <ul className="footer-list flex">
                        <li><a href="https://t.me/web3buffett" className="hover:text-yellow-300"><LinkedIn sx={{ fontSize: '2rem' }} /></a></li>
                        <li><a href="https://github.com/Rukandel" className="hover:text-yellow-300"><GitHub sx={{ fontSize: '2rem' }} /></a></li>
